...
obtain_stats_data()
{
    ...
    query_string='?q=*:*&fq=marker_symbol:*%20AND%20status:(Success%20OR%20%22Not%20tested%20(No%20variation)%20-%20OK%22)%20AND%20project_name:IMPC%20AND%20mp_term_id:*%20AND%20life_stage_name:%22Early%20adult%22';
