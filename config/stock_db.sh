...
# VIA_067_001 Homozygous-Lethal data
psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Lethal', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_statistical_result v where m.mgi_gene_acc_id = v.impc_marker_accession_id and v.parameter_stable_id='IMPC_VIA_067_001' and v.mp_term_id='MP:0011100' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"

# load additional VIA_067_001 Homozygous-Lethal data where synonyms can be resolved
# The version below was too slow
# psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Lethal', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_statistical_result v, (select mgi_gene_acc_id, synonym from mouse_gene_synonym where synonym in ( select tt.impc_marker_symbol from impc_statistical_result tt where tt.impc_marker_accession_id not in (select m2.mgi_gene_acc_id from mouse_gene m2))) as renamed where m.mgi_gene_acc_id = renamed.mgi_gene_acc_id and v.impc_marker_symbol =renamed.synonym and v.parameter_stable_id='IMPC_VIA_067_001' and v.mp_term_id='MP:0011100' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"

psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "WITH 
invalid_acc_ids AS (select tt.impc_marker_accession_id from impc_statistical_result tt except select m2.mgi_gene_acc_id from mouse_gene m2),
invalid_marker_symbols AS (select tt.impc_marker_symbol from impc_statistical_result tt, invalid_acc_ids where tt.impc_marker_accession_id=invalid_acc_ids.impc_marker_accession_id group by impc_marker_symbol),
renamed AS (select mgi_gene_acc_id, synonym from mouse_gene_synonym where synonym in (select impc_marker_symbol from invalid_marker_symbols)) 
INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) 
select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Lethal', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_statistical_result v, renamed where m.mgi_gene_acc_id = renamed.mgi_gene_acc_id and v.impc_marker_symbol =renamed.synonym and v.parameter_stable_id='IMPC_VIA_067_001' and v.mp_term_id='MP:0011100' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"



# VIA_067_001 Homozygous-Subviable data
psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Subviable', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_statistical_result v where m.mgi_gene_acc_id = v.impc_marker_accession_id and v.parameter_stable_id='IMPC_VIA_067_001' and v.mp_term_id='MP:0011110' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"

# load additional VIA_067_001 Homozygous-Subviable data where synonyms can be resolved

# Old version below - too slow
# psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Subviable', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_statistical_result v, (select mgi_gene_acc_id, synonym from mouse_gene_synonym where synonym in ( select tt.impc_marker_symbol from impc_statistical_result tt where tt.impc_marker_accession_id not in (select m2.mgi_gene_acc_id from mouse_gene m2))) as renamed where m.mgi_gene_acc_id = renamed.mgi_gene_acc_id and v.impc_marker_symbol =renamed.synonym and v.parameter_stable_id='IMPC_VIA_067_001' and v.mp_term_id='MP:0011110' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"
...
# VIA_067_001 Homozygous-Viable data
psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Viable', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_nonsig_statistical_result_tmp v where m.mgi_gene_acc_id = v.impc_marker_accession_id and v.parameter_stable_id='IMPC_VIA_067_001' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"

# load additional VIA_067_001 Homozygous-Viable data where synonyms can be resolved
#psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Viable', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_nonsig_statistical_result_tmp v, (select mgi_gene_acc_id, synonym from mouse_gene_synonym where synonym in ( select tt.impc_marker_symbol from impc_nonsig_statistical_result_tmp tt where tt.impc_marker_accession_id not in (select m2.mgi_gene_acc_id from mouse_gene m2))) as renamed where m.mgi_gene_acc_id = renamed.mgi_gene_acc_id and v.impc_marker_symbol =renamed.synonym and v.parameter_stable_id='IMPC_VIA_067_001' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"

psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "WITH 
invalid_acc_ids AS (select tt.impc_marker_accession_id from impc_nonsig_statistical_result_tmp tt except select m2.mgi_gene_acc_id from mouse_gene m2),
invalid_marker_symbols AS (select tt.impc_marker_symbol from impc_nonsig_statistical_result_tmp tt, invalid_acc_ids where tt.impc_marker_accession_id=invalid_acc_ids.impc_marker_accession_id group by impc_marker_symbol),
renamed AS (select mgi_gene_acc_id, synonym from mouse_gene_synonym where synonym in (select impc_marker_symbol from invalid_marker_symbols)) 
INSERT INTO combined_adult_viability (mouse_gene_id, allele_accession_id, allele_symbol, category, colony_id, genetic_background, life_stage_acc, life_stage_name, pipeline_name, pipeline_stable_id, procedure_name, procedure_stable_id, parameter_name, parameter_stable_id, phenotyping_center, project_name, strain_accession_id, strain_name, zygosity) 
select m.id, v.impc_allele_accession_id, v.impc_allele_symbol, 'Homozygous-Viable', v.colony_id, v.genetic_background, v.life_stage_acc, v.life_stage_name, v.pipeline_name, v.pipeline_stable_id, v.procedure_name, v.procedure_stable_id, v.parameter_name, v.parameter_stable_id, v.phenotyping_center, v.project_name, v.impc_strain_accession_id, v.impc_strain_name, v.zygosity from mouse_gene m, impc_nonsig_statistical_result_tmp v, renamed where m.mgi_gene_acc_id = renamed.mgi_gene_acc_id and v.impc_marker_symbol =renamed.synonym and v.parameter_stable_id='IMPC_VIA_067_001' and v.zygosity='homozygote' and v.life_stage_name='Earlyadult'"


# drop the temporary table
psql -v ON_ERROR_STOP=1 -U "$POSTGRES_USER" -d "$POSTGRES_DB" -c "DROP table impc_nonsig_statistical_result_tmp"
...
select oo.id, 'Cellular Lethal' as \"bin\", 'CL' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v 
where 
...
v.life_stage_name='Earlyadult' and
...
mouse_genes_with_distinct_homozgous_viability_call AS ((select m3.mgi_gene_acc_id from mouse_gene m3, combined_adult_viability v3 where m3.id = v3.mouse_gene_id and v3.zygosity='homozygote' and v3.life_stage_name='Earlyadult' group by m3.mgi_gene_acc_id having count(distinct(v3.id)) > 1 and count(distinct(v3.category))=1) UNION (select m4.mgi_gene_acc_id from mouse_gene m4, combined_adult_viability v4 where m4.id = v4.mouse_gene_id and v4.zygosity='homozygote' and v4.life_stage_name='Earlyadult' group by m4.mgi_gene_acc_id having count(distinct(v4.id)) = 1))
INSERT INTO fusil (ortholog_id, bin, bin_code) 
select oo.id, 'Developmental Lethal' as \"bin\", 'DL' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v 
where 
mm.id=oo.mouse_gene_id and 
mm.mgi_gene_acc_id in (select mgi_gene_acc_id from mouse_genes_with_single_human_ortholog) and 
oo.support_count > 4 and 
...
mouse_genes_with_distinct_homozgous_viability_call AS ((select m3.mgi_gene_acc_id from mouse_gene m3, combined_adult_viability v3 where m3.id = v3.mouse_gene_id and v3.zygosity='homozygote' and v3.life_stage_name='Earlyadult' group by m3.mgi_gene_acc_id having count(distinct(v3.id)) > 1 and count(distinct(v3.category))=1) UNION (select m4.mgi_gene_acc_id from mouse_gene m4, combined_adult_viability v4 where m4.id = v4.mouse_gene_id and v4.zygosity='homozygote' and v4.life_stage_name='Earlyadult' group by m4.mgi_gene_acc_id having count(distinct(v4.id)) = 1))
INSERT INTO fusil (ortholog_id, bin, bin_code) 
select oo.id, 'Subviable' as \"bin\", 'SV' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v 
where 
mm.id=oo.mouse_gene_id and 
mm.mgi_gene_acc_id in (select mgi_gene_acc_id from mouse_genes_with_single_human_ortholog) and 
oo.support_count > 4 and 
...
mouse_genes_with_distinct_homozgous_viability_call AS ((select m3.mgi_gene_acc_id from mouse_gene m3, combined_adult_viability v3 where m3.id = v3.mouse_gene_id and v3.zygosity='homozygote' and v3.life_stage_name='Earlyadult' group by m3.mgi_gene_acc_id having count(distinct(v3.id)) > 1 and count(distinct(v3.category))=1) UNION (select m4.mgi_gene_acc_id from mouse_gene m4, combined_adult_viability v4 where m4.id = v4.mouse_gene_id and v4.zygosity='homozygote' and v4.life_stage_name='Earlyadult' group by m4.mgi_gene_acc_id having count(distinct(v4.id)) = 1))
INSERT INTO fusil (ortholog_id, bin, bin_code) 
select oo.id, 'Subviable Outlier' as \"bin\", 'SV.outlier' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v 
where 
mm.id=oo.mouse_gene_id and 
mm.mgi_gene_acc_id in (select mgi_gene_acc_id from mouse_genes_with_single_human_ortholog) and 
oo.support_count > 4 and 
...
INSERT INTO fusil (ortholog_id, bin, bin_code) 
select oo.id, 'Viable With Phenotype' as \"bin\", 'VP' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v 
where 
mm.id=oo.mouse_gene_id and 
mm.mgi_gene_acc_id in (select mgi_gene_acc_id from mouse_genes_with_single_human_ortholog) and 
oo.support_count > 4 and 
...
INSERT INTO fusil (ortholog_id, bin, bin_code) 
select oo.id, 'Viable No Phenotype' as \"bin\", 'VN' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v
where 
mm.id=oo.mouse_gene_id and 
mm.mgi_gene_acc_id in (select mgi_gene_acc_id from mouse_genes_with_single_human_ortholog) and 
oo.support_count > 4 and 
...
mouse_genes_with_distinct_homozgous_viability_call AS ((select m3.mgi_gene_acc_id from mouse_gene m3, combined_adult_viability v3 where m3.id = v3.mouse_gene_id and v3.zygosity='homozygote' and v3.life_stage_name='Earlyadult' group by m3.mgi_gene_acc_id having count(distinct(v3.id)) > 1 and count(distinct(v3.category))=1) UNION (select m4.mgi_gene_acc_id from mouse_gene m4, combined_adult_viability v4 where m4.id = v4.mouse_gene_id and v4.zygosity='homozygote' and v4.life_stage_name='Earlyadult' group by m4.mgi_gene_acc_id having count(distinct(v4.id)) = 1))
INSERT INTO fusil (ortholog_id, bin, bin_code) 
select oo.id, 'Viable Outlier' as \"bin\", 'V.outlier' as \"bin_code\" from mouse_gene mm, human_gene hh, ortholog oo, achilles_gene_effect age, combined_adult_viability v 
where 
mm.id=oo.mouse_gene_id and 
mm.mgi_gene_acc_id in (select mgi_gene_acc_id from mouse_genes_with_single_human_ortholog) and 
oo.support_count > 4 and 
